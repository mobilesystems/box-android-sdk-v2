...
public class FileListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.btnUploadFile).setOnClickListener(new View.OnClickListener() {
        ...
        this.findViewById(R.id.btnDownloadFileViaPicker).setOnClickListener(new View.OnClickListener() {
        ...
        this.findViewById(R.id.btnChangeFolderLocationViaPicker).setOnClickListener(new View.OnClickListener() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case PICK_FOLDER_REQUEST:
                if (resultCode == Activity.RESULT_CANCELED) {
                    Toast.makeText(this, "No folder chosen", Toast.LENGTH_LONG).show();
                }
                else {
            ...
            case PICK_FILE_REQUEST:
                if (resultCode == Activity.RESULT_CANCELED) {
                    ...
                    BoxAndroidFile file = data.getParcelableExtra(FilePickerActivity.EXTRA_BOX_ANDROID_FILE);
                    downloadFile(file);
                }
                break;
