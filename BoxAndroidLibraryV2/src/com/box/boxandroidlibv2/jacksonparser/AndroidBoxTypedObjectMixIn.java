...
@JsonSubTypes({@Type(value = BoxAndroidFile.class, name = "file"), @Type(value = BoxAndroidFolder.class, name = "folder"), @Type(value = BoxWebLink.class, name = "web_link"),
               @Type(value = BoxAndroidCollaboration.class, name = "collaboration"), @Type(value = BoxAndroidComment.class, name = "comment"),
               @Type(value = BoxAndroidEmailAlias.class, name = "email_alias"), @Type(value = BoxAndroidFileVersion.class, name = "file_version"),
               @Type(value = BoxAndroidUser.class, name = "user"), @Type(value = BoxServerError.class, name = "error")})
